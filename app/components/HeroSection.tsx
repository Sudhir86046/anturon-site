...
{showIntroGlow && (
  <div className="pointer-events-none fixed inset-0 z-40 flex items-center justify-center bg-slate-950/60">
    ...
    />
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 pb-16 pt-24 md:flex-row md:items-center md:gap-12 md:pb-24 md:pt-28">
        ...
        >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              href="#book-demo"
              className="inline-flex items-center justify-center rounded-full bg-orange-500 px-6 py-2.5 text-sm font-semibold text-slate-950 shadow-sm transition hover:bg-orange-400"
            >
              Book a live demo
            </a>
            <a
              href="#playground"
              className="inline-flex items-center justify-center rounded-full border border-slate-700 px-5 py-2.5 text-sm font-medium text-slate-100 transition hover:border-slate-500 hover:bg-slate-900/60"
            >
          ...
          <p className="mt-3 text-[11px] text-slate-500 sm:text-xs">
            Plug &amp; play with your existing dialer, CRM and lead sources —
